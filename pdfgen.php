...
$result_check = $wpdb->query($wpdb->prepare(
    "INSERT INTO $table_name (`name`, `email`, `phone`, `file_name`, `cost_as_per_sqt`, `cost_per_ceiling_height`, `cost_as_per_bathroom_preference`, `bathroom_drain_cost`, `cost_as_per_kitchenette_preference`, `kitchenette_drain_cost`, `ceiling_type_cost`, `total_cost`) 
